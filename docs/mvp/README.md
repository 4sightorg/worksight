...
> **Base
> tip:** `feat/mvp-stabilize` (pnpm + Turbo; stacked PRs #21–#24)
...
- [x] common + web + api type-check/build green (stabilize / stacked PRs)
- [ ] Web dashboards consume `@worksight/common` fixtures/utils (#16 / PR #22)
- [ ] API shapes align with common types (#17 / PR #24)
- [ ] Documented demo path shows populated well-being/task views (#18)
- [ ] README matches Nest + Next 15 + packages reality (#19)
